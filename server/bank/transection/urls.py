...
from .views import PaymentTokenDUR,PaymentTokenGetPost, GetTokenApiTransection,CAutoPayToken,Transfar,AddPaymentToken ,GetPaymentTokenTransection,CheckValidPin,PaymentAddressGenerate,GetAccountInfo,UserAccountInfoDUR,GetAutoPayToken,AutoPayDUR,PaymentAddressGet,PaymentAddressDURDelete
